...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['customer/deleteCustomer/(:num)'] = 'CustomerController/deleteCustomer/$1';
...
$route['form/(:any)'] = 'controller/show_form/$1';
$route['open-form'] = 'FormController/open_form';
// $route['Link/(:any)'] = 'Link/retrieveHtmlCode/$1';
